        ...
        animationCallback: function (x, y) {
            ...
            if (slider_value > 5 && slider_value < 37) {
                ...
                /* if (slider_value > 18) {
                    ...
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
                    $("#device-holder").text('301 to 401');
                }
                if (slider_value > 24) {
                    $(".info-price").html('€ 929.20 / month');
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
                    $("#device-holder").text('401 to 501');
                }
                if (slider_value > 25) {
                    $(".info-price").html('€ 1161.50 / month');
                    $(".annual-price").html('€ 1500');
                    $("#device-holder").text('501 to 601');
                }
                if (slider_value > 26) {
                    $(".info-price").html('€ 1393.80 / month');
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
                    $("#device-holder").text('601 to 701');
                }
                if (slider_value > 27) {
                    $(".info-price").html('€ 1626.10 / month');
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
                    $("#device-holder").text('701 to 801');
                }
                if (slider_value > 28) {
                    $(".info-price").html('€ 1858.40 / month');
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
                    $("#device-holder").text('801 to 901');
                }
                if (slider_value > 29) {
                    $(".info-price").html('€ 2090.70 / month');
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
                    $("#device-holder").text('801 to 901');
                }
                if (slider_value > 31) {
                    $(".info-price").html('€ 2323.00 / month');
                    $(".annual-price").html('€ 1500');
                    $("#setup-fee").text('+ Setup fee:');
            ...
            if (slider_value > 38 && slider_value < 83) {
                ...
                if (slider_value > 40) {
                    $("#orange-highlight").css("width", "" + (slider_value / 4.8) + "%");
                }
                ...
                if (slider_value > 50) {
                    $("#orange-highlight").css("width", "" + (slider_value / 1.7) + "%");
                }
                ...
                if (slider_value > 68) {
                    $("#orange-highlight").css("width", "" + (slider_value / 1.6) + "%");
                }
            ...
            if (slider_value > 83) {
                ...
                if (slider_value > 88) {
                    $("#blue-highlight").css("width", "" + (slider_value / 10) + "%");
                }
                if (slider_value > 93) {
                    $("#blue-highlight").css("width", "" + (slider_value / 8) + "%");
                }
                if (slider_value > 97) {
                    $("#blue-highlight").css("width", "" + (slider_value / 6) + "%");
                }
