postsContainer = document.getElementById("newsContainer5");
var HTMLString = '';
var data;
...
function getPostDataRequest() {
    ...
    return new Promise(function (resolve, reject) {
        ...
        ourRequest.open('GET', 'https://blog.cib.de/wp-json/wp/v2/posts?categories=605291136&per_page=1');
        ourRequest.send();
    });
}
...
function createHtml(postData) {
    ...
    ourRequest.onload = function () {
        ...
        HTMLString += '<div id="newsItem" class="col-12 col-lg-4 pt-card pb-4">';
